...
The official emulator depends on C++/ZetaSQL, making it heavy for unit tests. This library provides a lightweight pure Go alternative that works directly with the `cloud.google.com/go/spanner` client library.
